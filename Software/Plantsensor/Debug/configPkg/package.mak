...
.dlls,em3 .dlls: main.pem3

-include package/cfg/main_pem3.mak
-include package/cfg/main_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/main_pem3.dep
endif
main.pem3: package/cfg/main_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
main.pem3 package/cfg/main_pem3.c: .libraries,em3
endif

package/cfg/main_pem3.c package/cfg/main_pem3.h package/cfg/main_pem3.xdl: override _PROG_NAME := main.xem3
package/cfg/main_pem3.c: package/cfg/main_pem3.cfg
package/cfg/main_pem3.xdc.inc: package/cfg/main_pem3.xdl
package/cfg/main_pem3.xdl package/cfg/main_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/main_pem3.cfg
	-$(RM) package/cfg/main_pem3.dep
	-$(RM) package/cfg/main_pem3.c
	-$(RM) package/cfg/main_pem3.xdc.inc

clean,em3::
	-$(RM) main.pem3
.executables,em3 .executables: main.xem3

main.xem3: |main.pem3

-include package/cfg/main.xem3.mak
main.xem3: package/cfg/main_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/main_pem3.oem3   package/cfg/main_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
main.xem3: export C_DIR=
main.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
main.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

main.test test,em3 test: main.xem3.test

main.xem3.test:: main.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 main.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.main.xem3, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
main_pem3.oem3,copy : package/cfg/main_pem3.oem3
main_pem3.sem3,copy : package/cfg/main_pem3.sem3
